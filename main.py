"""
This method is where the project will be ran from.
"""
import io
import requests
...
def get_meal_plan(calories, meals):
    ...
    driver.get(url)
    print('Locating eatthismuch.com...')
    time.sleep(5)
...
if __name__ == '__main__':
    # user inputs
    calories = input('Enter desired daily calories (0-20k): ')
    meals = input('Enter meal count per day (1-9): ')

    # get plan
    meal_plan = get_meal_plan(calories, meals)
    print(meal_plan)